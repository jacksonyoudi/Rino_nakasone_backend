...
if __name__ == '__main__':
    ...
    wechat_url = 'https://mp.weixin.qq.com/mp/getmasssendmsg?__biz=MzA3NDk1NjI0OQ==&uin=MjgxMTU0NDM1&key={0}&devicetype=Windows+10&version=6203005d&lang=zh_CN&ascene=7&pass_ticket=vbFYPkG%2FXKNQwJgsf2AF6LH3gE3ceAEvtzrNPxFswjfdlxJ5b5BYLTzxg4iitkHG'.format(
        key)

    wechat = Wechat(wechat_url)
